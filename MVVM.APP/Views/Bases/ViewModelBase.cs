using MVVM.APP.Commanding;
using MVVM.APP.Events.EventsArgs;
using MVVM.APP.Services.IOC.Default.Unity;
using MVVM.APP.Services.Services_Interfaces;
using System;
...
namespace MVVM.APP.Views.Bases
{
